...
It is possible to build the image for both Qemu and Beaglebone Black using the the ```vexpress-qemu``` or ```beaglebone``` machine type respectively.
