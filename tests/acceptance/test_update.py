    ...
    @pytest.mark.parametrize("sig_case",
                             [SignatureCase(label="Not signed, key not present, version 1",
                              ...
                              SignatureCase(label="EC, Correctly signed, but header does not match checksum, key present, version 2",
                                            ...
                                            artifact_version=2,
                                            success=False),
                              SignatureCase(label="Not signed, key not present, version 3",
                                            signature=False,
                                            signature_ok=False,
                                            key=False,
                                            key_type=None,
                                            ...
                                            artifact_version=3,
                                            success=True),
                              SignatureCase(label="RSA, Correctly signed, key present, version 3",
                                            signature=True,
                                            signature_ok=True,
                                            key=True,
                                            key_type="RSA",
                                            ...
                                            artifact_version=3,
                                            success=True),
                              SignatureCase(label="RSA, Incorrectly signed, key present, version 3",
                                            signature=True,
                                            signature_ok=False,
                                            key=True,
                                            key_type="RSA",
                                            ...
                                            artifact_version=3,
                                            success=False),
                              SignatureCase(label="RSA, Correctly signed, key not present, version 3",
                                            signature=True,
                                            signature_ok=True,
                                            key=False,
                                            key_type="RSA",
                                            ...
                                            artifact_version=3,
                                            success=True),
                              SignatureCase(label="RSA, Not signed, key present, version 3",
                                            signature=False,
                                            signature_ok=False,
                                            key=True,
                                            key_type="RSA",
                                            ...
                                            artifact_version=3,
                                            success=False),
                              SignatureCase(label="RSA, Correctly signed, but checksum wrong, key present, version 3",
                                            signature=True,
                                            signature_ok=True,
                                            key=True,
                                            key_type="RSA",
                                            ...
                                            artifact_version=3,
                                            success=False),
                              SignatureCase(label="EC, Correctly signed, key present, version 3",
                                            signature=True,
                                            signature_ok=True,
                                            key=True,
                                            key_type="EC",
                                            ...
                                            artifact_version=3,
                                            success=True),
                              SignatureCase(label="EC, Incorrectly signed, key present, version 3",
                                            signature=True,
                                            signature_ok=False,
                                            key=True,
                                            key_type="EC",
                                            ...
                                            artifact_version=3,
                                            success=False),
                              SignatureCase(label="EC, Correctly signed, key not present, version 3",
                                            signature=True,
                                            signature_ok=True,
                                            key=False,
                                            key_type="EC",
                                            ...
                                            artifact_version=3,
                                            success=True),
                              SignatureCase(label="EC, Not signed, key present, version 3",
                                            signature=False,
                                            signature_ok=False,
                                            key=True,
                                            key_type="EC",
                                            ...
                                            artifact_version=3,
                                            success=False),
                              SignatureCase(label="EC, Correctly signed, but checksum wrong, key present, version 3",
                                            signature=True,
                                            signature_ok=True,
                                            key=True,
                                            key_type="EC",
                                            ...
                                            artifact_version=3,
                                            success=False),
                              SignatureCase(label="EC, Correctly signed, but header does not match checksum, key present, version 3",
                                            signature=True,
                                            signature_ok=True,
                                            key=True,
                                            key_type="EC",
