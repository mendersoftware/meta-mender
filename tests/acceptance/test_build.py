...
MENDER_IMAGE_BOOT_FILES_append = " deployed-test1 deployed-test-dir2/deployed-test2 \
...
"""
        ...
        try:
            ...
            build_image(
                ...
                prepared_test_build["bitbake_corebase"],
                bitbake_image,
                ['MENDER_IMAGE_BOOT_FILES_append = " conflict-test1"'],
            )
            ...
            try:
                build_image(
                    ...
                    prepared_test_build["bitbake_corebase"],
                    bitbake_image,
                    ['MENDER_IMAGE_BOOT_FILES_append = " conflict-test2"'],
                )
                pytest.fail(
