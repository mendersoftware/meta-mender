...
class TestDeltaDockerComposeModule:
    @pytest.mark.only_with_image("ext4")
    def test_build_delta_docker_compose(
        ...
        build_image(
            ...
            [
                f'BBLAYERS:append = " {bitbake_variables["LAYERDIR_MENDER"]}/../meta-mender-commercial"',
        ...
        for path in [
            ...
            assert "Type: regular" in output, f"{path} missing or not a regular file"
