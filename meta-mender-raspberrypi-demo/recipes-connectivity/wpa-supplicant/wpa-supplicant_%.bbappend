...
SRC_URI_append_mender-client-install = " file://wpa_supplicant-wlan0.conf"

FILES_${PN}_append_mender-client-install = " ${sysconfdir}/wpa_supplicant/wpa_supplicant-wlan0.conf"
