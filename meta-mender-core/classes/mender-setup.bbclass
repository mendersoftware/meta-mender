...
python mender_sanity_handler() {
    ...
    if bb.utils.contains('MENDER_FEATURES_ENABLE', 'mender-partuuid', True, False, d) and not bb.utils.contains_any('TUNE_ARCH', 'i586 i686 x86 x86_64', True, False, d):
