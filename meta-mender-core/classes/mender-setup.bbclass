...
# The numbers of the two kernel partitions in the A/B partition layout.
# Normally unused
MENDER_KERNEL_PART_A_NUMBER ??= "${MENDER_KERNEL_PART_A_NUMBER_DEFAULT}"
MENDER_KERNEL_PART_A_NUMBER_DEFAULT = "${@bb.utils.contains('MENDER_BOOT_PART_SIZE_MB', '0', '3', '4', d)}"
MENDER_KERNEL_PART_B_NUMBER ??= "${MENDER_KERNEL_PART_B_NUMBER_DEFAULT}"
MENDER_KERNEL_PART_B_NUMBER_DEFAULT = "${@bb.utils.contains('MENDER_BOOT_PART_SIZE_MB', '0', '4', '5', d)}"
...
# The string path of the two kernel partitions in the A/B partition layout
MENDER_KERNEL_PART_A ??= "${MENDER_KERNEL_PART_A_DEFAULT}"
MENDER_KERNEL_PART_A_DEFAULT = "${MENDER_STORAGE_DEVICE_BASE}${MENDER_KERNEL_PART_A_NUMBER}"
MENDER_KERNEL_PART_B ??= "${MENDER_KERNEL_PART_B_DEFAULT}"
MENDER_KERNEL_PART_B_DEFAULT = "${MENDER_STORAGE_DEVICE_BASE}${MENDER_KERNEL_PART_B_NUMBER}"
...
# The names of the two kernel partitions in the A/B partition layout. By default
# it is the same name as MENDER_KERNEL_PART_A and MENDER_KERNEL_PART_B but normally
# is unused
MENDER_KERNEL_PART_A_NAME ??= "${MENDER_KERNEL_PART_A_NAME_DEFAULT}"
MENDER_KERNEL_PART_A_NAME_DEFAULT = "${MENDER_KERNEL_PART_A}"
MENDER_KERNEL_PART_B_NAME ??= "${MENDER_KERNEL_PART_B_NAME_DEFAULT}"
MENDER_KERNEL_PART_B_NAME_DEFAULT = "${MENDER_KERNEL_PART_B}"
...
# Set the fstab options for mounting the kernel partitions
MENDER_KERNEL_PART_A_FSTAB_OPTS ??= "${MENDER_KERNEL_PART_A_FSTAB_OPTS_DEFAULT}"
MENDER_KERNEL_PART_A_FSTAB_OPTS_DEFAULT = "defaults"
MENDER_KERNEL_PART_B_FSTAB_OPTS ??= "${MENDER_KERNEL_PART_B_FSTAB_OPTS_DEFAULT}"
MENDER_KERNEL_PART_B_FSTAB_OPTS_DEFAULT = "defaults"
...
# Set any extra options for creating the kernel partitions
MENDER_KERNEL_PART_A_FSOPTS ??= "${MENDER_KERNEL_PART_A_FSOPTS_DEFAULT}"
MENDER_KERNEL_PART_A_FSOPTS_DEFAULT = ""
MENDER_KERNEL_PART_B_FSOPTS ??= "${MENDER_KERNEL_PART_B_FSOPTS_DEFAULT}"
MENDER_KERNEL_PART_B_FSOPTS_DEFAULT = ""
...
# Size of the kernel partitions, zero means not required
MENDER_KERNEL_PART_A_SIZE_MB ??= "${MENDER_KERNEL_PART_A_SIZE_MB_DEFAULT}"
MENDER_KERNEL_PART_A_SIZE_MB_DEFAULT = "0"
MENDER_KERNEL_PART_B_SIZE_MB ??= "${MENDER_KERNEL_PART_B_SIZE_MB_DEFAULT}"
MENDER_KERNEL_PART_B_SIZE_MB_DEFAULT = "0"
