...
MENDER_SWAP_PART ??= "${MENDER_SWAP_PART_DEFAULT}"
MENDER_SWAP_PART_DEFAULT = "${MENDER_STORAGE_DEVICE_BASE}${@mender_get_swap_part_num(d)}"

MENDER_SWAP_MOUNTPOINT ??= "${MENDER_SWAP_MOUNTPOINT_DEFAULT}"
MENDER_SWAP_MOUNTPOINT_DEFAULT = "swap"
