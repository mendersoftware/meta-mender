...
python do_setcorelocation_mender-bios () {
    ...
    # The rest of core.img is always 1 sector after the disk boot.
    coreLoc = (int(d.getVar('MENDER_IMAGE_BOOTLOADER_BOOTSECTOR_OFFSET')) + 1)
    # This is the location where diskboot holds the location of core.
    # I haven't found a define for this
    kernelSector = 0x1F4
    some_bytes = coreLoc.to_bytes(6, byteorder='little')
...
do_setcorelocation_mender[vardeps] = " \
