...
SRC_URI = "git://${GO_IMPORT};protocol=https;destsuffix=${GO_SRCURI_DESTSUFFIX};branch=${MENDER_SNAPSHOT_BRANCH}"
...
LIC_FILES_CHKSUM = "file://src/${GO_IMPORT}/LICENSE;md5=a8c81350f12516cbb62844f937d81d11"
